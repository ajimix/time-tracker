...
web build:
 - http://mootools.net/core/694cc52e4e8f9882d3ae190f9a723363

packager build:
 - packager build Core/String Core/Number Core/Event Core/Element Core/Element.Event Core/Element.Delegation Core/JSON Core/DOMReady
...
};}});Number.implement(a);})(["abs","acos","asin","atan","atan2","ceil","cos","exp","floor","log","max","min","pow","sin","sqrt","tan"]);Array.implement({every:function(c,d){for(var b=0,a=this.length>>>0;
...
},periodical:function(c,b,a){return setInterval(this.pass((a==null?[]:a),b),c);}});(function(){var j=this.document;var g=j.window=this;var a=navigator.userAgent.toLowerCase(),b=navigator.platform.toLowerCase(),h=a.match(/(opera|ie|firefox|chrome|version)[\s\/:]([\w\d\.]+)?.*?(safari|version[\s\/:]([\w\d\.]+)|$)/)||[null,"unknown",0],d=h[1]=="ie"&&j.documentMode;
...
}}}return this;}};[Element,Window,Document].invoke("implement",{addEvent:e(f,g.addEvent),removeEvent:e(j,g.removeEvent)});})();if(typeof JSON=="undefined"){this.JSON={};
